...
export const InProcessCard: FC<InProcessCardProps> = ({ getDndItem }) => {
    ...
    return (
        <>
            {myContext.inProcessTasks.map((task: any, index: any) => (
                <div className="task_wrap" key={task.get('idItem')} id={task.get('idItem')} draggable onDragStart={allowDrop}>
                    ...
                    <div className="check">
                        ...
                        <div className="redo_button" id={task.get('idItem')} onClick={edit}></div>
